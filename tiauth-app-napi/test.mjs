import { createResetProof, createSetClaimsProof, createResetProofKey, createProofKey, createSetClaimsProofBytes } from './index.js'
...
for (let i = 0; i < count; i++) {
    ...
    // const proof = createResetProofKey("some_app", key, "abc7")
